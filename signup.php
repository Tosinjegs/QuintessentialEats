...
<html class="h-full">
  <body class="light:bg-slate-900 bg-gray-100 flex-col items-center py-16">
        ...
        <div class="p-4 sm:p-7">
          <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
              ...
              <a class="text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="loginpage.php">
                Sign in here
              </a>
            </p>
          </div>
          ...
          <div class="mt-5">
            ...
            <form>
              <div class="grid gap-y-4">
                ...
                <button type="submit" class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="loginpage.php">Sign up</button>
              </div>
            </form>
            <!-- End Form -->
          </div>
